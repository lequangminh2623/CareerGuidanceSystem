...
import com.lqm.academic_service.configs.JwtConfig;
 ...
 * trong RabbitMQ thread (không có HTTP request context).
 *
...
public class SystemJwtTokenProvider {
     ...
     * Subject là "academic-service" để phân biệt với user token.
     */
    private String generateSystemJwt() {
        try {
            ...
            String payloadJson = String.format(
                    "{\"sub\":\"academic-service\",\"role\":\"ROLE_ADMIN\",\"iat\":%d,\"exp\":%d}",
                    now, exp);
